...
class TestExtractMediaId:
    ...
    def test_invalid_url(self):
        assert ArticleService._extract_media_id_from_download_url('https://example.com/img.png') is None
...
class TestBuildArticleBodySourceKey:
    ...
    def test_data_url_hashed(self):
        key = ArticleService._build_article_body_source_key('data:image/png;base64,AAAA' + 'A' * 200)
...
def test_serialize_media_asset_failed_status_priority():
    ...
    media_asset = SimpleNamespace(
        ...
        wechat_mappings=[
            SimpleNamespace(
                id=11, account_id=2, wechat_url='', upload_status='failed',
                error_message='network error', uploaded_at=None, created_at=None, updated_at=None,
            ),
            SimpleNamespace(
                id=12, account_id=1, wechat_url='https://mmbiz.qq.com/success.png',
                upload_status='success', error_message='', uploaded_at=None, created_at=None, updated_at=None,
            ),
        ],
    )
...
def test_serialize_media_asset_processing_over_success():
    ...
    media_asset = SimpleNamespace(
        id=3, filename='cover.png', stored_filename='c.png', content_type='image/png',
        file_size=2048, tags=[], description='', owner_email='', source_kind='article_cover',
        source_url='', article_id=99, created_at=None,
        wechat_mappings=[
            SimpleNamespace(
                id=31, account_id=9, wechat_url='ok.png', upload_status='success',
                error_message='', uploaded_at=None, created_at=None, updated_at=None,
            ),
            SimpleNamespace(
                id=32, account_id=10, wechat_url='', upload_status='processing',
                error_message='', uploaded_at=None, created_at=None, updated_at=None,
            ),
        ],
    )
...
def test_serialize_media_asset_all_pending():
    ...
    media_asset = SimpleNamespace(
        id=4, filename='f.png', stored_filename='f.png', content_type='image/png',
        file_size=512, tags=[], description='', owner_email='', source_kind='manual',
        source_url='', article_id=None, created_at=None,
        wechat_mappings=[
            SimpleNamespace(
                id=41, account_id=1, wechat_url='', upload_status='pending',
                error_message='', uploaded_at=None, created_at=None, updated_at=None,
            ),
        ],
    )
...
def test_serialize_media_asset_no_mappings():
    ...
    media_asset = SimpleNamespace(
        id=5, filename='orphan.png', stored_filename='o.png', content_type='image/png',
        file_size=256, tags=[], description='', owner_email='', source_kind='manual',
        source_url='', article_id=None, created_at=None,
        wechat_mappings=[],
    )
    payload = _serialize_media_asset(media_asset)
