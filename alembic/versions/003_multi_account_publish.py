...
def downgrade() -> None:
    op.drop_index(
        "ix_article_publish_relations_sync_status", table_name="article_publish_relations"
    )
    op.drop_index(
        "ix_article_publish_relations_publish_status", table_name="article_publish_relations"
    )
