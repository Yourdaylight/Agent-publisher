...
def downgrade() -> None:
    op.drop_index('ix_media_asset_wechat_mappings_upload_status', table_name='media_asset_wechat_mappings')
    op.drop_index('ix_media_asset_wechat_mappings_account_id', table_name='media_asset_wechat_mappings')
    op.drop_index('ix_media_asset_wechat_mappings_media_asset_id', table_name='media_asset_wechat_mappings')
