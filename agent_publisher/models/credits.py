...
class CreditsTransaction(Base):
    ...
    operation_type: Mapped[str] = mapped_column(String(50))  # generate_article, generate_image, rewrite, recharge, etc.
    credits_amount: Mapped[int] = mapped_column(Integer)  # negative=consume, positive=recharge
    balance_after: Mapped[int] = mapped_column(Integer)
    reference_id: Mapped[int | None] = mapped_column(Integer, nullable=True, default=None)  # article_id / image_id etc.
